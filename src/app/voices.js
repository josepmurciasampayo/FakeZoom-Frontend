import { Spectrum } from "./canvas/spectrum";
import { hannWindow, linearInterpolation } from './lib/pitch/utils';
import { autoCorrelate } from './lib/pitch/pitch_detector';
...
export class Voice {
    ...
    constructor(stream, audioCtx, elm) {
        ...
        // audio analyser
        this.spectrum = new Spectrum(this.audioCtx, elm);
